export default {
  ...
  error: {
    ...
    codes: {
      ...
      403005: 'Удаление аккаунта отключено',
      403006: 'Ошибка учетных данных почтового агента',
  ...
  account: {
    ...
    delete: {
      ...
      description: 'Удалите свой аккаунт навсегда. Это действие нельзя отменить.',
      confirm: 'Вы уверены, что хотите удалить свой аккаунт? Это действие нельзя отменить.',
      form: {
        password: {
          label: 'Пароль',
